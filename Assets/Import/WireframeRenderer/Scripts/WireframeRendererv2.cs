...
public class WireframeRendererv2 : MonoBehaviour
{
	...
	void UpdateLines()
	{
		...
		wireframeRenderer.sharedMaterial.SetFloat("_LineSize", LineSize);
	}

	void UpdateShaded()
	{
		originalRenderer.enabled = Shaded;
		wireframeRenderer.enabled = Wireframed;
	}
    ...
    {
		Material mat = new(originalRenderer.sharedMaterial);
		mat.SetFloat("_Surface", 1.0f);
		mat.SetFloat("_QueueOffset", -1.0f);
		mat.shader = Shader.Find("Universal Render Pipeline/Transparent Lit");
		return mat;
	}
